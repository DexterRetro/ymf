...
const validator = require('validator');
 ...
 const scheme = new mongoose.Schema({
     ...
     YMFID:{type:String},
     role: {type: String,enum: ['general-member','corporate-membership','board-member', 'admin'],default: 'general-member',},
     extraRoles:{type: String,enum: ['editor', 'accounting', 'IT','registrar']},
     password: {type: String,required: [true, 'password is required'],minlength: 8,select:false,},passwordChangedAt: {type: Date,},
     ...
     Province: {type: String,
      ...
      ProfilePhoto: {type: String,default: '/image/noProfile.jpg',},
