...
const validator = require('validator');
 ...
 const scheme = new mongoose.Schema({
     ...
     password: {type: String,required: [true, 'password is required'],minlength: 8,},passwordChangedAt: {type: Date,},
     passwordConfirm: {type: String,required: [true, 'passwordConfirm is required'],minlength: 8,
        validate: {
      ...
      YMFID:{type:String,required:true},
     ...
     Province: {type: String,
      ...
      NationalIDPIC:{required:true,type:String}
...
scheme.pre('save',async function(next){
 ...
 const user = mongoose.model('TransUser',scheme,'transUser');
 module.exports = user;
